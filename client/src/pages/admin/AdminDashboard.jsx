    ...
    const handleUpdateStatus = async (orderId, newStatus) => {
        try {
            ...
            const res = await axios.post(
                "http://localhost:4000/api/admin/update-status",
                payload
            );
            ...
            <div className="flex items-center justify-between px-4 md:px-8 border-b border-gray-300 py-3 bg-white sticky top-0 z-20">
                ...
                <div className="flex items-center gap-5">
                    ...
                    <button
                        ...
                        className='border border-gray-300 rounded-full text-sm px-4 py-1 hover:bg-red-50 hover:text-red-600 transition-all'
                    >
                        Logout
                    </button>
                </div>
                    ...
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="bg-white p-4 border border-gray-300 rounded-lg mb-6 flex flex-wrap justify-between items-center gap-4">
                            ...
                            <div className="flex flex-1 md:max-w-md gap-2">
                                ...
                                <button
                                    onClick={downloadPDF}
                                    className="bg-blue-600 text-white px-4 py-2 rounded-md text-xs font-bold uppercase hover:bg-blue-700"
                                >
                                    Export
                                </button>
                            </div>
                        ...
                        <div className="bg-white border border-gray-300 rounded-lg overflow-hidden shadow-sm">
                            ...
                            <table className="w-full text-left">
                                ...
                                <tbody className="divide-y divide-gray-200">
                                    ...
                                    {loading ? (
                                        <tr>
                                            <td colSpan="4" className="p-10 text-center text-blue-600 animate-pulse font-bold">
                                            ...
                                            <tr key={item._id} className="hover:bg-gray-50 transition-colors">
                                                ...
                                                <td className="p-4">
                                                    <p className="font-bold text-sm text-gray-800 leading-tight">
                                                        {item.name || `Order #${item._id.substring(18)}`}
                                                    </p>
                                                ...
                                                <td className="p-4 text-right">
                                                    ...
                                                    {activeTab === 'products' && (
                                                        <button
                                                            ...
                                                            className="text-red-500 text-[11px] font-bold uppercase hover:bg-red-50 px-2 py-1 rounded"
                                                        >
                                                            Delete
                                                        </button>
                                                    )}
